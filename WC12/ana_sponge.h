...
! Western boundary
      DO j=JstrR,JendR
        DO i=IstrR,MIN(nc_w,IendR)
          cff=visc2(ng)+REAL(nc_w-i,r8)*                                &
     &        (fac*visc2(ng)-visc2(ng))/REAL(nc_w,r8)
          visc2_r(i,j)=cff
          visc2_p(i,j)=cff
        END DO
      END DO
! Eastern boundary
      DO j=JstrR,JendR
        DO i=MAX(IstrR,Lm(ng)+1-nc_e),IendR
          cff=visc2(ng)+REAL(i-(Lm(ng)+1-nc_e),r8)*                     &
     &        (fac*visc2(ng)-visc2(ng))/REAL(nc_e,r8)
          visc2_r(i,j)=cff
          visc2_p(i,j)=cff
        END DO
      END DO
! Southern boundary
      DO i=IstrR,IendR
        DO j=JstrR,MIN(nc_s,JendR)
          cff=visc2(ng)+REAL(nc_s-j,r8)*                                &
     &        (fac*visc2(ng)-visc2(ng))/REAL(nc_s,r8)
...
! Northern boundary
      DO i=IstrR,IendR
        DO j=MAX(JstrR,Mm(ng)+1-nc_n),JendR
          cff=visc2(ng)+REAL(j-(Mm(ng)+1-nc_n),r8)*                     &
     &        (fac*visc2(ng)-visc2(ng))/REAL(nc_n,r8)
          visc2_r(i,j)=visc2_r(i,j)+cff
          visc2_p(i,j)=visc2_p(i,j)+cff
        END DO
      END DO
...
! Western boundary
      DO j=JstrR,JendR
        DO i=IstrR,MIN(nc_w,IendR)
          cff1=tnu2(itemp,ng)+REAL(nc_w-i,r8)*                          &
     &         (fac*tnu2(itemp,ng)-tnu2(itemp,ng))/REAL(nc_w,r8)
          cff2=tnu2(isalt,ng)+REAL(nc_w-i,r8)*                          &
     &         (fac*tnu2(isalt,ng)-tnu2(isalt,ng))/REAL(nc_w,r8)
...
! Eastern boundary
      DO j=JstrR,JendR
        DO i=MAX(IstrR,Lm(ng)+1-nc_e),IendR
          cff1=tnu2(itemp,ng)+REAL(i-(Lm(ng)+1-nc_e),r8)*               &
     &         (fac*tnu2(itemp,ng)-tnu2(itemp,ng))/REAL(nc_e,r8)
          cff2=tnu2(isalt,ng)+REAL(i-(Lm(ng)+1-nc_e),r8)*               &
     &         (fac*tnu2(isalt,ng)-tnu2(isalt,ng))/REAL(nc_e,r8)
...
! Southern boundary
      DO i=IstrR,IendR
        DO j=JstrR,MIN(nc_s,JendR)
          cff1=tnu2(itemp,ng)+REAL(nc_s-j,r8)*                          &
     &         (fac*tnu2(itemp,ng)-tnu2(itemp,ng))/REAL(nc_s,r8)
          cff2=tnu2(isalt,ng)+REAL(nc_s-j,r8)*                          &
     &         (fac*tnu2(isalt,ng)-tnu2(isalt,ng))/REAL(nc_s,r8)
          diff2(i,j,itemp)=diff2(i,j,itemp)+cff1
          diff2(i,j,isalt)=diff2(i,j,isalt)+cff2
        END DO
      END DO
! Northern boundary
      DO i=IstrR,IendR
        DO j=MAX(JstrR,Mm(ng)+1-nc_n),JendR
          cff1=tnu2(itemp,ng)+REAL(j-(Mm(ng)+1-nc_n),r8)*               &
     &         (fac*tnu2(itemp,ng)-tnu2(itemp,ng))/REAL(nc_n,r8)
          cff2=tnu2(isalt,ng)+REAL(j-(Mm(ng)+1-nc_n),r8)*               &
     &         (fac*tnu2(isalt,ng)-tnu2(isalt,ng))/REAL(nc_n,r8)
          diff2(i,j,itemp)=diff2(i,j,itemp)+cff1
          diff2(i,j,isalt)=diff2(i,j,isalt)+cff2
        END DO
      END DO
